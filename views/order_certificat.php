...
<p>Je soussignée, Mr. Fuchs Leander, gérant de Open Hongkong Co., Ltd., assure et déclare, sous ma seule responsabilité, que le dispositif médical sur mesure CAS No <?php echo $order_id; ?> , est mis sur le marché pour l'usage exclusif du patient identifié sous le numéro: <?php echo $order_patient_id; ?> suivant les caractéristiques spécifiques du produits indiquées par la prescription du client identifié par la référence <?php echo $order_ref; ?>.
</p>
